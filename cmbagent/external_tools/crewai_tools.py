...
def get_crewai_free_tools() -> List[AG2ToolAdapter]:
    ...
    Example:
        ...
        >>> print(f"Found {len(tools)} CrewAI tools")
    """
    tools = []
    ...
    try:
        ...
        print(f"Warning: Could not import CrewAI file tools: {e}")
    ...
    try:
        ...
        print(f"Warning: Could not import CrewAI code tools: {e}")
    ...
    try:
        ...
        print(f"Warning: Could not import CrewAI web tools: {e}")
    ...
    try:
        ...
        print(f"Warning: Could not import CrewAI search tools: {e}")
    ...
    try:
        ...
        print(f"Warning: Could not import CrewAI PDF tools: {e}")
    ...
    try:
        ...
        print(f"Warning: Could not import CrewAI GitHub tools: {e}")
