...
def get_langchain_free_tools() -> List[AG2ToolAdapter]:
    ...
    try:
        ...
        print(f"Warning: Could not import Wikipedia tool: {e}")
    ...
    try:
        ...
        print(f"Warning: Could not import ArXiv tool: {e}")
    ...
    try:
        ...
        print(f"Warning: Could not import DuckDuckGo search tool: {e}")
    ...
    try:
        ...
        print(f"Warning: Could not import Python REPL tool: {e}")
    ...
    try:
        ...
        print(f"Warning: Could not import file management tools: {e}")
    ...
    try:
        ...
        print(f"Warning: Could not import Shell tool: {e}")
    ...
    try:
        ...
        print(f"Warning: Could not import JSON tools: {e}")
    ...
    try:
        ...
        print(f"Warning: Could not import Requests tools: {e}")
...
def get_langchain_web_tools() -> List[AG2ToolAdapter]:
    ...
    try:
        ...
        print(f"Warning: Could not import web tools: {e}")
...
def get_langchain_code_tools() -> List[AG2ToolAdapter]:
    ...
    try:
        ...
        print(f"Warning: Could not import code tools: {e}")
