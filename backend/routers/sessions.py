"""
Session Management API (Stages 10-11)

REST endpoints for managing workflow sessions across ALL modes:
...
Supported modes: copilot, planning-control, one-shot, hitl-interactive,
idea-generation, ocr, arxiv, enhance-input
"""
